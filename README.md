...
- Agentic RAG system for regulatory reasoning over the EU AI Act. Planner-driven multi-hop retrieval ensures strictly grounded, explainable answers, served via a production-ready FastAPI backend.
