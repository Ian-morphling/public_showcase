#  Public Project Showcase – Ian Ling
...
- **Tech Stack: Prophet, pandas, Flask, matplotlib, Plotly.
...
- **Tech Stack: Dagster, GeoPandas, pandas, matplotlib

###  [EDA & Visualization – Mexico COVID-19](./mexico-covid)
- **Objective: Perform exploratory analysis on COVID-19 cases in Mexico.
- **Highlights: Created insightful queries and data stories using visualizations to reveal regional patterns in healthcare burden and response.
